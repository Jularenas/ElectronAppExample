...
export class AddPatientComponent implements OnInit {
  ...
  @Input() nombreFormGroup: FormGroup;
  @Input()documentoFormGroup: FormGroup;
  @Input()ciudadFormGroup: FormGroup;
  @Input()sintomaFormGroup: FormGroup;
  @Input()urlFormGroup: FormGroup;
